        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              console.log('New content is available and will be used when ' +
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log('This web app is being served cache-first by a ' +
              'service worker. To learn more, visit http://bit.ly/CRA-PWA');
        });
      } else {
