...
events.on("image_push", function(e, project) {
  ...
  notify.tasks = [
    ...
    "curl -X POST -H 'Content-Type: application/json' --data '{\"username\":\"Brigade\",\"icon_emoji\":\":k8s:\",\"text\":\"Directory prod deployment updated.\"}' https://message.gccollab.ca/hooks/$CHATKEY"      //rocket chat notification webhook
  ]
